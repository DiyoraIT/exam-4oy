...
let NewAlert = 5 % 2;
 alert("5 ni 2 ga bo'lishda qoldiq: " + NewAlert);
...
let harflar = ["a" , "b" , "d" , "e" , "f" , "g" , "h" , "i" , "j" , "k" , "l" , "m" , "n" , "o" , "p" , "q" , "r" , "s" , "t",  "u" , "v" , "x" , "y" , "z" ]
console.log(`${harflar[2]}${harflar[7]}${harflar[22]}${harflar[13]}${harflar[16]}${harflar[0]}`);
...
let Myname = "Diyora"; 
let teskariIsm = Myname.split('').reverse().join('');
